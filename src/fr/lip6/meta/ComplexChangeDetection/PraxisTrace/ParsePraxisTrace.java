...
public class ParsePraxisTrace {

	protected File fileTrace = null;
	protected ArrayList<String> parsedTrace = null;
	protected ArrayList<String> praxisTrace = null;
	...
	public ParsePraxisTrace() {
		
	}

	public ParsePraxisTrace(File fileTrace) {
		this.fileTrace = fileTrace;
		this.parsedTrace = new ArrayList<String>();
	}
	
	public ParsePraxisTrace(ArrayList<String> praxisTrace) {
		this.praxisTrace = praxisTrace;
		this.parsedTrace = new ArrayList<String>();
	}
		...
		while(i < initTrace.size()){
			...
			if(this.getKind(initTrace.get(i)).equals("addReference") 
					...
					&& (this.getSingleName(initTrace.get(i)).equals("eoperation")
							...
							|| this.getSingleName(initTrace.get(i)).equals("econtainingclass"))){
