...
public class MainEMFCompare {

	public static void main(String[] args) {
		MainEMFCompare mainEMFCompare = new MainEMFCompare();
		//mainEMFCompare.detectComplexChangeFromEMFCompareDiff("Model/test2.ecore", "Model/test3.ecore");
		mainEMFCompare.detectComplexChangeFromEMFCompareDiff(
				//"Model/PivotV6.0.1.ecore", "Model/PivotV6.1.0.ecore");
	...
	public void detectComplexChangeFromEMFCompareDiff(String source, String target){
		...
		*/
		...
		//here we compute the diff with EMF Compare
		...
		generic.detect(changes); //parse.getEvolutionTrace().getAtomicEvolutionTrace());
		detectedComplexChanges = generic.validateDetectedCC(changes, initState, new ArrayList<ComplexChange>()); //parse.getEvolutionTrace().getAtomicEvolutionTrace()
		generic.detectMoreCC(detectedComplexChanges);
		detectedComplexChanges = generic.validateDetectedCC(changes, initState, detectedComplexChanges); //parse.getEvolutionTrace().getAtomicEvolutionTrace()
