...
public class DefinitionHiddenMoveV1 implements GenericDefinition{

	public ArrayList<AtomicChange> genericDefinitions = null;
	
	public DefinitionHiddenMoveV1(){
		...
		this.genericDefinitions.add(new RenameProperty());
	}
	...
	public TemporaryComplexChange create() {
		// TODO Auto-generated method stub
		return new TemporaryHiddenMoveV1();
	}
