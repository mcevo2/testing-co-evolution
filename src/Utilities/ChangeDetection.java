...
*/
	...
	/*	ArrayList<String> subclasses = new ArrayList<String>();
		...
		DeleteProperty dp1 = new DeleteProperty("postAction", "ElementTypeConfiguration"); //after the class rename 
		DeleteProperty dp2 = new DeleteProperty("preAction", "ElementTypeConfiguration");
		DeleteProperty dp3 = new DeleteProperty("preValidation", "ElementTypeConfiguration");
		...
		changes.add(ap4);
*/
	/*	RenameProperty rp1 = new RenameProperty("reference", "ownedReference", "AnnotationCS");
		changes.add(rp1);
		
		MoveProperty mp1 = new MoveProperty("multiplicity", "TypedElementCS", "TypedRefCS"); //through ownedType 0..1
		//here below it is double move, from TypedElementCS to TypedRefCS and then from TypedRefCS to MultiplicityCS
		MoveProperty mp2 = new MoveProperty("upper", "TypedElementCS", "TypedRefCS"); //through ownedType 0..1
		MoveProperty mp3 = new MoveProperty("lower", "TypedElementCS", "TypedRefCS"); //through ownedType 0..1
		MoveProperty mp4 = new MoveProperty("upper", "TypedRefCS", "MultiplicityCS"); //through multiplicity 0..1
		MoveProperty mp5 = new MoveProperty("lower", "TypedRefCS", "MultiplicityCS"); //through multiplicity 0..1
		...
		ArrayList<ComplexChange> moves1 = new ArrayList<ComplexChange>();
		ArrayList<ComplexChange> moves2 = new ArrayList<ComplexChange>();
		
		//here two successive moves in two extract classes
		MoveProperty mp6 = new MoveProperty("uri", "ImportCS", "PathNameCS"); 
		MoveProperty mp7 = new MoveProperty("uri", "PathNameCS", "PathElementCS");
	
		moves1.add(mp6);
		moves2.add(mp7);
		
		ExtractClass ec1 = new ExtractClass("EC", "ImportCS", "PathNameCS", null, moves1);
		ExtractClass ec2 = new ExtractClass("EC", "PathNameCS", "PathElementCS", null, moves2);
		...
		ArrayList<String> subclasses = new ArrayList<String>();
		subclasses.add("PathElementCS");

		PushProperty pup1 = new PushProperty("uri", "PathElementWithURICS", subclasses); // after it has been moved two times
		changes.add(pup1);
		
		
		
		ArrayList<ComplexChange> pulls1 = new ArrayList<ComplexChange>();
		ArrayList<String> subclasses1 = new ArrayList<String>();
		subclasses1.add("PackageCS");
		
		PullProperty pp5 = new PullProperty("ownedNestedPackage", "PackageOwnerCS", subclasses1);
		pulls1.add(pp5);
		
		ExtractSuperClass esc1 = new ExtractSuperClass("ESC", "PackageOwnerCS", subclasses1, null, pulls1);
		changes.add(esc1);
		
		ArrayList<ComplexChange> pulls2 = new ArrayList<ComplexChange>();
		ArrayList<String> subclasses2 = new ArrayList<String>();
		subclasses2.add("ModelElementCS");
		
		PullProperty pp6 = new PullProperty("pivot", "PivotableElementCS", subclasses2);
		pulls1.add(pp6);
		
		ExtractSuperClass esc2 = new ExtractSuperClass("ESC", "PivotableElementCS", subclasses1, null, pulls2);
		changes.add(esc2);
		
		//here if the infos in the two changes are not sufficient, we can improve the change and add missing infos, i put them in comments below
		SetProperty sp1 = new SetProperty("ownedActualParameter", "class","TypeRefCS", false); //ownedActualParameter from ParameterableElementCS to TypeRefCS, in TemplateParameterSubstitutionCSImpl/TemplateParameterSubstitutionCS
		SetProperty sp2 = new SetProperty("multiplicity","class", "MultiplicityCS", false); //multiplicity from STring to MultiplicityCS, in TypedRefCS (after the move from TypedElementCS) 
		
		changes.add(sp1);
		changes.add(sp2);
		
		DeleteProperty dp1 = new DeleteProperty("ownedConstraint", "TypedElementCS"); 
		DeleteProperty dp2 = new DeleteProperty("namespace", "TypedTypeRefCS");
					
		DeleteProperty dp3 = new DeleteProperty("moniker", "MonikeredElementCS");
		DeleteProperty dp4 = new DeleteProperty("hasMoniker", "MonikeredElementCS");
		...
		DeleteSuperType dst1 = new DeleteSuperType("ParameterableElementCS", "MonikeredElementCS");
		DeleteSuperType dst2 = new DeleteSuperType("CollectionTypeRefCS", "TypedTypeRefCS");
		DeleteSuperType dst3 = new DeleteSuperType("ClassCSRef", "ElementCS");
		DeleteSuperType dst4 = new DeleteSuperType("TypeRefCS", "ParameterableElementCS");
		DeleteSuperType dst5 = new DeleteSuperType("TypeCS", "MonikeredElementCS");
		DeleteSuperType dst6 = new DeleteSuperType("MonikeredElementCS", "ModelElementCS");
		DeleteSuperType dst7 = new DeleteSuperType("NamedElementCS", "MonikeredElementCS");
		DeleteSuperType dst8 = new DeleteSuperType("PrimitiveTypeRefCS", "NamedElementCS");
		DeleteSuperType dsT9 = new DeleteSuperType("SpecificationCS", "MonikeredElementCS");
		DeleteSuperType dst10 = new DeleteSuperType("RootPackageCS", "PackageCS");
		DeleteSuperType dst11 = new DeleteSuperType("ClassifierCS", "ParameterableElementCS");
		DeleteSuperType dst12 = new DeleteSuperType("LambdaTypeCS", "NamedElementCS");
		DeleteSuperType dst13 = new DeleteSuperType("ModelElementCS", "ElementCS");
		DeleteSuperType dst14 = new DeleteSuperType("TemplateBindingCS", "ModelElementCS"); //here, reduced the generalization
		DeleteSuperType dst15 = new DeleteSuperType("TemplateSignatureCS", "MonikeredElementCS");
		DeleteSuperType dst16 = new DeleteSuperType("TemplateableElementCS", "MonikeredElementCS");
		DeleteSuperType dst17 = new DeleteSuperType("TupleTypeCS", "NamedElementCS");
		...
		AddClass ac1 = new AddClass("ScopeFilter"); //data class
		AddClass ac2 = new AddClass("PivotableElementCS");
		AddClass ac3 = new AddClass("PathNameCS");
		AddClass ac4 = new AddClass("PathElementWithURICS");
		AddClass ac5 = new AddClass("PathElementCS");
		AddClass ac6 = new AddClass("PackageOwnerCS");
		AddClass ac7 = new AddClass("MultiplicityStringCS");
		AddClass ac8 = new AddClass("MultiplicityCS");
		AddClass ac9 = new AddClass("MultiplicityBoundsCS");
		AddClass ac10 = new AddClass("ModelElementRefCS");
		AddClass ac11 = new AddClass("ElementRefCS"); 
		...
		AddProperty ap1 = new AddProperty("pathName", "TypedTypeRefCS");
		AddProperty ap2 = new AddProperty("optional", "TypedElementCS");
		AddProperty ap3 = new AddProperty("name", "TupleTypeCS");
		AddProperty ap4 = new AddProperty("ownedDefaultExpression", "StructuralFeatureCS");
		AddProperty ap5 = new AddProperty("ast", "StructuralFeatureCS"); //this ast() and below are methods
		AddProperty ap6 = new AddProperty("scopeFilter", "PathNameCS");
		AddProperty ap7 = new AddProperty("context", "PathNameCS");
		AddProperty ap8 = new AddProperty("element", "PathNameCS");
		AddProperty ap9 = new AddProperty("path", "PathNameCS");
		AddProperty ap10 = new AddProperty("elementType", "PathElementCS");
		AddProperty ap11 = new AddProperty("element", "PathElementCS");
		AddProperty ap12 = new AddProperty("pathName", "PathElementCS");
		AddProperty ap13 = new AddProperty("ast", "ParameterCS");
		AddProperty ap14 = new AddProperty("ast", "PackageCS");
		AddProperty ap15 = new AddProperty("ownedBodyExpression", "OperationCS");
		AddProperty ap16 = new AddProperty("ownedPostcondition", "OperationCS");
		AddProperty ap17 = new AddProperty("ownedPrecondition", "OperationCS");
		AddProperty ap18 = new AddProperty("ast", "OperationCS");
		AddProperty ap19 = new AddProperty("element", "ModelElementRefCS");
		AddProperty ap20 = new AddProperty("pathName", "ModelElementRefCS");
		AddProperty ap21 = new AddProperty("csi", "ModelElementCS");
		AddProperty ap22 = new AddProperty("name", "LambdaTypeCS");
		AddProperty ap23 = new AddProperty("all", "ImportCS");
		AddProperty ap24 = new AddProperty("pathName", "ImportCS");
		AddProperty ap25 = new AddProperty("ast", "EnumerationCS");
		AddProperty ap26 = new AddProperty("logicalParent", "ElementCS");
		AddProperty ap27 = new AddProperty("ast", "ClassifierCS");
		AddProperty ap28 = new AddProperty("getUpper", "MultiplicityCS");
		AddProperty ap29 = new AddProperty("getLower", "MultiplicityCS");
		AddProperty ap30 = new AddProperty("ast", "EnumerationLiteralCS");
		AddProperty ap31 = new AddProperty("name", "PrimitiveTypeRefCS");
		AddProperty ap32 = new AddProperty("stringBounds", "MultiplicityStringCS");
		AddProperty ap33 = new AddProperty("upperBound", "MultiplicityBoundsCS");
		AddProperty ap34 = new AddProperty("lowerBound", "MultiplicityBoundsCS");
		...
		AddSuperType ast1 = new AddSuperType("TemplateableElementCS", "ElementCS");
		AddSuperType ast2 = new AddSuperType("TemplateSignatureCS", "ModelElementCS");
		AddSuperType ast3 = new AddSuperType("TemplateBindingCS", "ElementRefCS");//reduce the generalization
		AddSuperType ast4 = new AddSuperType("PivotableElementCS", "ElementCS");
		AddSuperType ast5 = new AddSuperType("PathNameCS", "ElementCS");
		AddSuperType ast6 = new AddSuperType("PathElementCS", "ElementCS");
		AddSuperType ast7 = new AddSuperType("PackageOwnerCS", "ModelElementCS");
		AddSuperType ast8 = new AddSuperType("PackageCS", "PackageOwnerCS");
		AddSuperType ast9 = new AddSuperType("ModelElementRefCS", "ElementRefCS");
		AddSuperType ast10 = new AddSuperType("ModelElementCS", "PivotableElementCS");
		AddSuperType ast11 = new AddSuperType("MultiplicityCS", "ElementCS");	
		AddSuperType ast12 = new AddSuperType("RootPackageCS", "PackageOwnerCS");
		AddSuperType ast13 = new AddSuperType("SpecificationCS", "ModelElementCS"); //generalize super type
		AddSuperType ast14 = new AddSuperType("PathElementWithURICS", "PathElementCS");
		AddSuperType ast15 = new AddSuperType("NamedElementCS", "ModelElementCS");
		AddSuperType ast16 = new AddSuperType("MultiplicityStringCS", "MultiplicityCS");
		AddSuperType ast17 = new AddSuperType("MultiplicityBoundsCS", "MultiplicityCS");
		AddSuperType ast18 = new AddSuperType("ElementRefCS", "PivotableElementCS");
		AddSuperType ast19 = new AddSuperType("TypeCS", "ModelElementCS");
		AddSuperType ast20 = new AddSuperType("", "");
		AddSuperType ast21 = new AddSuperType("", "");
		AddSuperType ast22 = new AddSuperType("", "");
