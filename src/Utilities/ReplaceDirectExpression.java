...
public class ReplaceDirectExpression {
	 ...
	 */
	public static void replaceExpressionInParentNode(ASTNode oldExp, ASTNode newExp){
		
		if(oldExp.getParent() instanceof Statement){
			replaceExpressionInParentNodeStatement(oldExp, newExp);
			
		} else if(oldExp.getParent() instanceof Expression){
			replaceExpressionInParentNodeExpression(oldExp, newExp);
	...
	private static void replaceExpressionInParentNodeStatement(ASTNode oldExp, ASTNode newExp){
...
//			}
	...
	private static void replaceExpressionInParentNodeExpression(ASTNode oldExp, ASTNode newExp){
